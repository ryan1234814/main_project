# Normal (Scalar RV64IMAFD) vs Custom Vector (AISS custom-0) — Execution Comparison
...
bash tests/run-tests.sh          # 15 demo PASS correctness
bash tests/unit/run-unit.sh      # 32 unit PASS: each op alone + 2 chains, hw==sw==ref
```
